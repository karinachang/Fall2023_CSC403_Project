...
{
    public partial class FrmBattle_Boss : Form
    {
        public static FrmBattle_Boss instance = null;
        private BossHershey enemy;
        private Player player;

        private FrmBattle_Boss()
        {
            InitializeComponent();
            player = Game.player;
        }
        ...
        public static FrmBattle_Boss GetInstance(BossHershey enemy)
        {
            if (instance == null)
            {
                instance = new FrmBattle_Boss();
