...
{
    public partial class FrmBattle_Reeses : Form
    {
        public static FrmBattle_Reeses instance = null;
        private Reeses enemy;
        private Player player;

        private FrmBattle_Reeses()
        {
            InitializeComponent();
            player = Game.player;
        }
        ...
        public static FrmBattle_Reeses GetInstance(Reeses enemy)
        {
            if (instance == null)
            {
                instance = new FrmBattle_Reeses();
        ...
        private void btnAttack_Click(object sender, EventArgs e)
        {
            ...
            if (enemy.Health > 0)
                enemy.OnAttack(enemyHitAmount()); //range -4, -5, -6
